...
class GetLatestSmartphoneUseCase @Inject constructor(
    private val latestSmartphoneRepository: LatestSmartphoneRepository,
) {
    operator fun invoke(): Flow<Result<List<Phone>>> {
        return latestSmartphoneRepository.getLatestSmartphone()
    }
}
