...
package com.dirzaaulia.smartphonespec.core.designsystem.theme
...
internal val md_theme_light_secondary = Color(0xFF385BA9)
internal val md_theme_light_onSecondary = Color(0xFFFFFFFF)
internal val md_theme_light_secondaryContainer = Color(0xFFD9E2FF)
...
internal val md_theme_dark_secondary = Color(0xFFB1C6FF)
internal val md_theme_dark_onSecondary = Color(0xFF002C70)
internal val md_theme_dark_secondaryContainer = Color(0xFF1B438F)
internal val md_theme_dark_onSecondaryContainer = Color(0xFFD9E2FF)
...
internal val seed = Color(0xFF424242)
